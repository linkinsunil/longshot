const keywordDifficulty = function (value) {
  if (value > 85) {
    ...
    return {
      rating: 'Hard',
      text: 'Even stiffer competition. These keywords will demand moreeffort in terms of getting higher authority referring domains in order to rank your well-optimized and helpful content among the top pages.',
      color: '#FF4953',
    };
  } else if (value >= 50) {
    return {
